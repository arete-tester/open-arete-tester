...
{
    [Serializable]
    public class SelectFieldMapping : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public SelectFieldMapping()
        {
            this.ActionType = "SelectFieldMapping";
            this.Description = "Select Field Mapping";
            this.Variable = "@var";
        }
        ...
        public override ValidationResult Validate()
        {
            ...
            {
                result.Messages.Add(new ValidationMessage() { MessageType = ValidationMessageType.Error, Message = "Field is empty." });
            }
