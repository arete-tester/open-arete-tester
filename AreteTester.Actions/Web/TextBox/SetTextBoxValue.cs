...
{
    [Serializable]
    public class SetTextBoxValue : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public SetTextBoxValue()
        {
            this.ActionType = "SetTextBoxValue";
        ...
        public override ValidationResult Validate()
        {
            ...
            {
                result.Messages.Add(new ValidationMessage() { MessageType = ValidationMessageType.Warning, Message = "Value is empty." });
            }
