...
{
    [Serializable]
    public class DeselectListboxItemByText : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public DeselectListboxItemByText()
        {
            this.ActionType = "DeselectListboxItemByText";
        }
        ...
        public override void Process()
        {
            ...
            element.DeselectByText(this.Text);
