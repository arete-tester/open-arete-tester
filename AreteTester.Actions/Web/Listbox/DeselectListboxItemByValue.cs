...
{
    [Serializable]
    public class DeselectListboxItemByValue : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public DeselectListboxItemByValue()
        {
            this.ActionType = "DeselectListboxItemByValue";
        }
        ...
        public override void Process()
        {
            ...
            element.DeselectByValue(this.Value);
