...
{
    [Serializable]
    public class IsListboxMultipleSelectionAllowed : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public IsListboxMultipleSelectionAllowed()
        {
            this.ActionType = "IsListboxMultipleSelectionAllowed";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(Variable, element.IsMultiple);
