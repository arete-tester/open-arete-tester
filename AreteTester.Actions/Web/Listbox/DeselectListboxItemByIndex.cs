...
{
    [Serializable]
    public class DeselectListboxItemByIndex : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public DeselectListboxItemByIndex()
        {
            this.ActionType = "DeselectListboxItemByIndex";
        }
        ...
        public override void Process()
        {
            ...
            element.DeselectByIndex(this.Index);
