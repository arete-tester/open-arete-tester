...
{
    [Serializable]
    public class GetDropdownItemsCount : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public GetDropdownItemsCount()
        {
            this.ActionType = "GetDropdownItemsCount";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(Variable, element.Options.Count);
