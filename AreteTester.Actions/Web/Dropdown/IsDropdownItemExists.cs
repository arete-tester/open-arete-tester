...
{
    [Serializable]
    public class IsDropdownItemExists : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public IsDropdownItemExists()
        {
            this.ActionType = "IsDropdownItemExists";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(Variable, exists);
        ...
        public override ValidationResult Validate()
        {
            ...
            {
                result.Messages.Add(new ValidationMessage() { MessageType = ValidationMessageType.Error, Message = "OptionText is empty." });
            }
