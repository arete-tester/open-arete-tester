...
{
    [Serializable]
    public class IsAlertDisplayed : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public IsAlertDisplayed()
        {
            this.ActionType = "IsAlertDisplayed";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            IAlert alert = ExpectedConditions.AlertIsPresent().Invoke(Globals.Driver);

            Variables.Instance.SetValue(Variable, alert != null);
