...
{
    [Serializable]
    public class GetCheckBoxCaption : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public GetCheckBoxCaption()
        {
            this.ActionType = "GetCheckBoxCaption";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            string caption = element.GetAttribute("value");

            Variables.Instance.SetValue(Variable, caption);
