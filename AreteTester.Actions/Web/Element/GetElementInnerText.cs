...
{
    [Serializable]
    public class GetElementInnerText : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public GetElementInnerText()
        {
            this.ActionType = "GetElementInnerText";
            this.Variable = "@var";
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(this.Variable, innerText);
