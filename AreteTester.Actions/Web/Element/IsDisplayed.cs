...
{
    [Serializable]
    public class IsDisplayed : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public override void Process()
        {
            ...
            try
            {
                ...
                Variables.Instance.SetValue(Variable, element.Displayed);
            }
            catch
            {
                Variables.Instance.SetValue(Variable, false);
            }
