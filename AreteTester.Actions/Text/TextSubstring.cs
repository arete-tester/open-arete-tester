...
{
    [Serializable]
    public class TextSubstring : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public TextSubstring()
        {
            this.ActionType = "TextSubstring";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(this.Variable, (text == null ? String.Empty : text.Substring(this.Index, this.Length)));
        ...
        public override ValidationResult Validate()
        {
            ...
            if (this.Length < 0)
            {
                result.Messages.Add(new ValidationMessage() { MessageType = ValidationMessageType.Error, Message = "Length cannot be less than zero." });
            }
