...
{
    [Serializable]
    public class TextEndsWith : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(this.Variable, (text == null ? false : text.EndsWith(this.TextToCompare)));
