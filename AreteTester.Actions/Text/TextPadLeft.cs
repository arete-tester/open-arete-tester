...
{
    [Serializable]
    public class TextPadLeft : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(this.Variable, (text == null ? "" : text.PadLeft(this.Width, this.Character)));
