...
{
    [Serializable]
    public class TextStartsWith : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public TextStartsWith()
        {
            this.ActionType = "TextStartsWith";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(this.Variable, (text == null ? false : text.StartsWith(this.TextToCompare)));
