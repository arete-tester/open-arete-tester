...
{
    [Serializable]
    public class GetRegexMatchInText : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        public GetRegexMatchInText()
        {
            this.ActionType = "GetRegexMatchInText";
            this.Variable = "@var";
        }
        ...
        public override void Process()
        {
            ...
            Variables.Instance.SetValue(this.Variable, regex.Match(text));
