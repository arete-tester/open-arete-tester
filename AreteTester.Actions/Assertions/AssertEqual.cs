...
{
    [Serializable]
    public class AssertEqual : ActionBase
    {
        [XmlAttribute]
        [Category("Properties")]
        ...
        [XmlAttribute]
        [Category("Properties")]
        public AssertEqualType Type { get; set; }

        public AssertEqual()
        {
            this.ActionType = "AssertEqual";
            this.Variable = "@var";
        }
        ...
        public override void  Process()
        {
            ...
            bool result = Assert.AreEqual(this.Expected, Variables.Instance.GetValue(Variable), this.Type);
            ...
            NotifyOutput(new Output()
            {
                ...
                Actual = Variables.Instance.GetValue(Variable).ToString(),
                Success = result
            });
        }
